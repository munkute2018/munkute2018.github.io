...
<section class="section">
    <?php $form = ActiveForm::begin(['id' => 'form-modal', 'enableClientValidation' => false, 'enableAjaxValidation' => true, 'validationUrl' => Yii::$app->urlManager->createUrl(['quyetdinh/formvalidate'])]); ?>
    <div class="row">
        ...
        <div class="card card-block">
          <div class="form-group">
            <label class="control-label">Tiêu đề</label>
              <?php 
                echo $form->field($model, 'name')->textInput(['class' => 'form-control underlined', 'maxlength' => 255, 'autofocus' => 'autofocus', 'placeholder' => 'Nhập tiêu đề quyết định...',])->label(false);
              ?>
          </div>
        </div>
      </div>
