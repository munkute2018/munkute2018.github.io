...
<section class="section">
    <?php $form = ActiveForm::begin(['id' => 'form-modal', 'enableClientValidation' => false, 'enableAjaxValidation' => true, 'validationUrl' => Yii::$app->urlManager->createUrl(['donvi/formvalidate'])]); ?>
    <div class="row">
        ...
        <div class="card card-block">
          <div class="form-group">
            <label class="control-label">Mã đơn vị</label>
              <?php 
                echo $form->field($model, 'madonvi')->widget(NumberControl::classname(), [
                    'maskedInputOptions' => [
                        'groupSeparator' => '',
                        'digits' => 0,
                        'rightAlign' => false,
