...
<section class="section">
    <?php $form = ActiveForm::begin(['options'=>['enctype'=>'multipart/form-data', 'id' => 'form-themdanhmuc', 'enableClientValidation' => false, 'enableAjaxValidation' => true, 'validationUrl' => Yii::$app->urlManager->createUrl(['nuocsx/importvalidate'])]]); ?>
    <div class="row">
...
$script = <<< JS
  $(document).ready(function () { 
    ...
    {
      window.location.href = 'downloads/import_nuocsx.xls';
    });
  });  
JS;
