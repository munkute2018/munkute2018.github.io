        ...
        'buttons' => [
            ...
            'delete' => function ($url, $model, $key) {
                return Html::a('<span class="glyphicon glyphicon-trash"></span>',false, [
                    ...
                    'data-toggle' => 'tooltip',
                    'data-url' => $url,
                    'data-confirm' => 'Mã nhà sản xuất là <b>'.$model->id.'</b> và tên nhà sản xuất là <b>'.$model->ten_nsx.'</b>',
                ]);
            },
        ],
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <p class="breadcrumb box-gridview">Danh mục nhà sản xuất (Áp dụng cho HIS L3)</p>
    </section>
                                ...
                                [
                                    'content' =>
                                        Html::button('<i class="fa fa-plus"></i>', [
                                            ...
                                            'data-url' => Url::to(['nhasx/create']),
                                            'title' => 'Thêm mới',
                                        ]) . ' '.
                                        Html::a('<i class="fa fa-undo"></i>', Url::to(['nhasx/index']), [
                                            'class' => 'btn btn-default',
