...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <p class="breadcrumb box-gridview">Danh mục huyện</p>
    </section>
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        echo GridView::widget([
                                ...
                                [
                                    'content' =>
                                        Html::button('<i class="fa fa-plus"></i>', [
                                            ...
                                            'data-url' => Url::to(['huyen/create']),
                                            'title' => 'Thêm mới',
                                        ]) . ' '.
                                        Html::a('<i class="fa fa-undo"></i>', Url::to(['huyen/index']), [
                                            'class' => 'btn btn-default',
                            ...
                            'itemLabelSingle' => 'huyện',
                            'itemLabelPlural' => 'huyện',
                            'pager' => [
