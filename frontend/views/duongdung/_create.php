...
<section class="section">
    <?php $form = ActiveForm::begin(['id' => 'form-modal', 'enableClientValidation' => false, 'enableAjaxValidation' => true, 'validationUrl' => Yii::$app->urlManager->createUrl(['duongdung/formvalidate'])]); ?>
    <div class="row">
      <div class="col-xs-12 col-sm-4 col-md-4">
        <div class="card card-block">
          <div class="form-group">
            <label class="control-label">Mã đường dùng</label>
              <?php echo $form->field($model, 'id')->textInput(['class' => 'form-control underlined', 'maxlength' => 4, 'autofocus' => 'autofocus', 'placeholder' => 'Nhập mã đường dùng...',])->label(false); ?>
          </div>
        </div>
      </div>
      <div class="col-xs-12 col-sm-4 col-md-4">
