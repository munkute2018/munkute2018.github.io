        ...
        'buttons' => [
            ...
            'delete' => function ($url, $model, $key) {
                return Html::a('<span class="glyphicon glyphicon-trash"></span>',false, [
                    ...
                    'data-toggle' => 'tooltip',
                    'data-url' => $url,
                    'data-confirm' => 'Mã đường dùng là <b>'.$model->id.'</b> và tên đường dùng là <b>'.$model->mota.'</b>',
                ]);
            },
        ],
...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <p class="breadcrumb box-gridview">Danh mục đường dùng</p>
    </section>
                                ...
                                [
                                    'content' =>
                                        Html::button('<i class="fa fa-plus"></i>', [
                                            ...
                                            'data-url' => Url::to(['duongdung/create']),
                                            'title' => 'Thêm mới',
                                        ]) . ' '.
                                        Html::a('<i class="fa fa-undo"></i>', Url::to(['duongdung/index']), [
                                            'class' => 'btn btn-default',
                                        ...
                                        Html::button('<i class="fa fa-upload"></i>', [
                                            ...
                                            'data-url' => Url::to(['duongdung/import']),
