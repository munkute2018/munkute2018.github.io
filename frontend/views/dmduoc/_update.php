...
$flag_phienban = ThuVien::checkIsL2ByIDPhieu($model->id_phieu);
...
<section class="section">
    <?php $form = ActiveForm::begin(['id' => 'form-modal', 'enableClientValidation' => false, 'enableAjaxValidation' => true, 'validationUrl' => Yii::$app->urlManager->createUrl(['convert/formeditvalidate', 'id' => $model->id])]); ?>
    <div class="row">
