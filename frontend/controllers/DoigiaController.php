 ...
 * Site controller
 */
class DoigiaController extends Controller
{
    ...
    public function actionIndex(){
        if (Yii::$app->user->can('doigia/index')) {
    ...
    public function actionCreate()
    {
        ...
        {
            if (Yii::$app->user->can('doigia/create')) {
                $model = new HisWork();
                ...
                if (Yii::$app->request->isAjax && $model->load(Yii::$app->request->post())) {
                    ...
                    return Json::encode(array('status' => true, 'title' => 'Thêm phiếu chuyển đổi giá DVKT', 'data' => $this->renderAjax('_create', ['model' => $model])));
                }
            }
            else{
